package ps.hacking.zxing.pdf417.decoder;
...
final class DecodedBitStreamParser {
    ...
    /* renamed from: ps.hacking.zxing.pdf417.decoder.DecodedBitStreamParser.1 */
    static /* synthetic */ class C00941 {
        static final /* synthetic */ int[] f22xd831b6e9;

        static {
            f22xd831b6e9 = new int[Mode.values().length];
            try {
                f22xd831b6e9[Mode.ALPHA.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f22xd831b6e9[Mode.LOWER.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f22xd831b6e9[Mode.MIXED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f22xd831b6e9[Mode.PUNCT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f22xd831b6e9[Mode.ALPHA_SHIFT.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f22xd831b6e9[Mode.PUNCT_SHIFT.ordinal()] = 6;
    ...
    private static void decodeTextCompaction(int[] textCompactionData, int[] byteCompactionData, int length, StringBuilder result) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            char ch = '\u0000';
            switch (C00941.f22xd831b6e9[subMode.ordinal()]) {
