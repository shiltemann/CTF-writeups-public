package ps.hacking.zxing.datamatrix.decoder;
...
final class DecodedBitStreamParser {
    ...
    /* renamed from: ps.hacking.zxing.datamatrix.decoder.DecodedBitStreamParser.1 */
    static /* synthetic */ class C00901 {
        static final /* synthetic */ int[] f21x82f16c2c;

        static {
            f21x82f16c2c = new int[Mode.values().length];
            try {
                f21x82f16c2c[Mode.C40_ENCODE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f21x82f16c2c[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f21x82f16c2c[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f21x82f16c2c[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f21x82f16c2c[Mode.BASE256_ENCODE.ordinal()] = 5;
    ...
    static DecoderResult decode(byte[] bytes) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                switch (C00901.f21x82f16c2c[mode.ordinal()]) {
