...
Interesting, ok, lets run it, ok, we are asked for a flag and told no when we enter it incorrectly
...
by bruteforcing each subseqent character and determine the correct on from the number
