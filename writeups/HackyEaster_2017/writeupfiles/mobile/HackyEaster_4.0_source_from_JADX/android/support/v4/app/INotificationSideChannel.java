        ...
        private static class Proxy implements INotificationSideChannel {
            ...
            public void notify(String packageName, int id, String tag, Notification notification) throws RemoteException {
                ...
                try {
                    ...
                    if (notification != null) {
                        _data.writeInt(Stub.TRANSACTION_notify);
                        notification.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    this.mRemote.transact(Stub.TRANSACTION_notify, _data, null, Stub.TRANSACTION_notify);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void cancel(String packageName, int id, String tag) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(id);
                    _data.writeString(tag);
                    this.mRemote.transact(Stub.TRANSACTION_cancel, _data, null, Stub.TRANSACTION_notify);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public void cancelAll(String packageName) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(packageName);
                    this.mRemote.transact(Stub.TRANSACTION_cancelAll, _data, null, Stub.TRANSACTION_notify);
                } finally {
                    _data.recycle();
                }
            }
